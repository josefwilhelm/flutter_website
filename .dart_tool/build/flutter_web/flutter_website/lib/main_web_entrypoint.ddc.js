define(['dart_sdk', 'packages/flutter_website/main'], function(dart_sdk, packages__flutter_website__main) {
  'use strict';
  ...
  const main = packages__flutter_website__main.main;
  ...
  dart.trackLibraries("packages/flutter_website/main_web_entrypoint", {
    "package:flutter_website/main_web_entrypoint.dart": main_web_entrypoint
  }, {
