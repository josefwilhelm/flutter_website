define(['dart_sdk', 'packages/flutter/src/widgets/actions', 'packages/flutter/src/painting/_network_image_web', 'packages/flutter/src/rendering/animated_size'], function(dart_sdk, packages__flutter__src__widgets__actions, packages__flutter__src__painting___network_image_web, packages__flutter__src__rendering__animated_size) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C1 = dart.const({
        ...
        [_Location_column]: 14,
        [_Location_line]: 13,
        [_Location_file]: "org-dartlang-app:///packages/flutter_website/widgets/centered_view.dart"
      });
    },
    get C7() {
  ...
  centered_view.CenteredView = class CenteredView extends framework.StatelessWidget {
    ...
    build(context) {
      return new container.Container.new({padding: C0 || CT.C0, alignment: alignment.Alignment.topCenter, child: new basic.ConstrainedBox.new({constraints: new box.BoxConstraints.new({maxWidth: 1600.0}), child: this.child, $creationLocationd_0dea112b090073317d4: C1 || CT.C1}), $creationLocationd_0dea112b090073317d4: C5 || CT.C5});
    }
  };
  ...
  dart.setLibraryUri(centered_view.CenteredView, "package:flutter_website/widgets/centered_view.dart");
  dart.setFieldSignature(centered_view.CenteredView, () => ({
    __proto__: dart.getFields(centered_view.CenteredView.__proto__),
    child: dart.finalFieldType(framework.Widget)
  }));
  dart.trackLibraries("packages/flutter_website/widgets/centered_view", {
    "package:flutter_website/widgets/centered_view.dart": centered_view
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["centered_view.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAIe;;;;;;UAIa;AACxB,YAAO,+DAEgB,sCACd,2CACQ,sCAAyB,iBAC/B;IAGb;;;QAZwB;QAAU;;;AAAU,8DAAW,GAAG;;EAAC","file":"centered_view.ddc.js"}');
  // Exports:
  return {
    widgets__centered_view: centered_view
  };
});
